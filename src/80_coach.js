...
function cExHtml(di, ei, e){
  ...
  return '<div class="exc">' +
    '<div class="row"><span class="c-lbl" style="flex:0 0 22px;text-align:left">' + (ei + 1) + '</span><input class="in sm grow" placeholder="Название" value="' + esc(e.name || "") + '" oninput="' + p + '.name=this.value">' +
    ...
    '<div class="row"><span class="c-lbl">подх.</span><input class="in sm num" type="number" value="' + (e.sets || 4) + '" oninput="' + p + '.sets=+this.value">' +
    '<span class="c-lbl">повт. от</span><input class="in sm num" type="number" value="' + (e.lo || 10) + '" oninput="' + p + '.lo=+this.value">' +
    '<span class="c-lbl">до</span><input class="in sm num" type="number" value="' + (e.hi || 12) + '" oninput="' + p + '.hi=+this.value"></div>' +
    '<div class="row"><span class="c-lbl">шаг, кг</span><input class="in sm num" type="number" step="0.5" value="' + (e.step != null ? e.step : 2.5) + '" oninput="' + p + '.step=+this.value">' +
    '<span class="c-lbl">суперсет №</span><input class="in sm num" type="number" placeholder="—" value="' + (e.sg || "") + '" oninput="' + p + '.sg=this.value?+this.value:undefined">' +
